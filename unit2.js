...
// 1. Тебе ее нужно преобразовать в строку
// 2. Проверить размерность больше или меньше 3 , работаем только с 3-х значным.
// 3. Суммируем значения с приведением к целочисленному виду.
// 4. Проверяем на четность
